  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "bg-background data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 fixed top-[50%] left-[50%] z-50 grid grid-rows-[auto_minmax(0,1fr)] w-[calc(100vw-1rem)] max-w-[calc(100vw-1rem)] max-h-[calc(100dvh-1rem)] translate-x-[-50%] translate-y-[-50%] gap-3 overflow-hidden rounded-[1.25rem] border p-3 shadow-lg duration-200 sm:w-[min(92vw,40rem)] sm:max-w-[min(92vw,40rem)] sm:max-h-[calc(100dvh-2rem)] sm:gap-4 sm:rounded-[1.75rem] sm:p-6 lg:w-full",
          className
        )}
